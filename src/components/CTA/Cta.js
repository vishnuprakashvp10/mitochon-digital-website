...
export default function Cta({ heading, para, connectHref = "/contact-us", knowMoreHref = "/about-us" }) {
    return (
        <div className="app__container">
          <div className="relative isolate overflow-hidden bg-indigo px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            <svg
