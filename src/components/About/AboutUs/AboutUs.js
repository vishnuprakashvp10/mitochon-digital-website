      ...
      <div className="app__container grid grid-cols-1 md:grid-cols-2 gap-8 relative items-center">
        ...
        <div className="we-are-content">
          ...
          <p className="app__text pb-12 text-justify">
            ...
            India. We&apos;re not just good at what we do; we genuinely care
            about doing it right. Everyone here brings their own flair to the
            table, but we all share the same goal: to make a real difference for
            the brands we work with. No egos, no fluff—just honest work, done
            ...
            win&apos;s a team win, and every lesson&apos;s a chance to level up
            together.
          </p>
