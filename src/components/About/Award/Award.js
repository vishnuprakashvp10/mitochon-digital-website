...
const Award = () => {
  const [countingOn, setCountingOn] = useState(false)
    const stats = [
        ...
        { id: 2, name: 'Business owners are happy with us', value: <CountUp start={0} end={10} duration={3}/>,icon:UserIcon},
