    ...
    <div className="app__container grid grid-cols-1 md:grid-cols-2 gap-8 relative">
      <div className="my-auto order-2 md:order-1">
        <div className="we-are-content">
          ...
          We at Mitochon Pixel provide top-notch social media marketing services that help you outperform competitors.
          </p>
        </div>
      </div>
      ...
      <div className="we-are-banner-img">
        <Image src={image.socialMarketing} alt="SEM Marketing" />
      </div>
    </div>
    </div>
  </section>
