        ...
        <div className="row">
          <div className="pb-12 text-center">
            ...
            <p className="app__text">
              At Mitochon Pixel, we offer a variety of SEO services to cater to
              your business&apos;s unique requirements. Whether you need local
              SEO services for small business, link building services, or
              professional SEO services agency support, we have you covered.
            </p>
          </div>
        </div>
        <motion.div
