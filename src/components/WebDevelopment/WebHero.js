...
const WebHero = () => { 
  return (
    ...
    <h1 className="text-2xl lg:text-4xl font-extrabold  mb-4 capitalise">We Adore <span className="highlight">Shaping</span> Websites!<br/>We Excel <span className="highlight">Building</span> Your Brand!</h1>
