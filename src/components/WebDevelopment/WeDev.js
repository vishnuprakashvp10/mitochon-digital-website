...
const features = [
  {
    ...
    description:
      "Our web developers continuously refine and adapt your website’s design to meet evolving trends and customer expectations.",
    icon: CodeBracketIcon,
  },
  {
    name: "Unique Content Research",
    description:
      "Our SEO specialists craft engaging, informative content, incorporating infographics and maps to highlight your product’s features and benefits.",
    icon: PencilSquareIcon,
  },
  {
    name: "Website Maintenance",
    description:
      "From designing eye-catching templates to developing a fully functional website, our team handles it all.",
    icon: CodeBracketSquareIcon,
  },
  {
    name: "Targeted Audience & SEO",
    description:
      "At Mitochon Pixel, we go beyond just reaching your target audience, we help expand your reach to potential new customers.",
    icon: UserGroupIcon,
  },
];
      ...
      <div className="app__container">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 app__text text-center">
            At Mitochon Pixel, we take care of everything from website
            development to content creation, SEO, and beyond. With us, you get a
            complete package that ensures your online presence is powerful and
            effective.
          </p>
        </div>
