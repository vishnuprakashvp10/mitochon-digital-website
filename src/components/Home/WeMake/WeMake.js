			...
			<div className="app__container">
				<div className="mx-auto max-w-2xl lg:text-center">
					...
					<p className="mt-6 text-lg leading-8 app__text text-center">
						For more expert advice on smarter investments and effective
						promotional strategies, contact Mitochon Digital. Because we&apos;re
						committed to accelerating your success.
					</p>
				</div>
