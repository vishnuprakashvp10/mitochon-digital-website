...
const Home = () => {
  return (
    ...
    <div
    className="flex-1">
    <h1 className="text-4xl lg:text-6xl text-white font-extrabold mb-4 capitalize">Mitochon Digital - Making your digital dreams a reality !</h1>
    <p className="text-base text-white mb-4">
We specializes in crafting targeted digital marketing strategies that elevate your online presence and achieve measurable results. Our seasoned experts are proficient in identifying and highlighting the unique characteristics and potential of a brand or product.</p>
    <div className="flex gap-5">
    <Link href="/contact-us" className="primary-btn shadow-lg">Get Started</Link>
    <Link href="/about-us" className="secondary-btn shadow-lg">Know More</Link>
    </div>
    </div>
