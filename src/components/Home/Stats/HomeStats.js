...
const HomeStats = () => {
  ...
  return (
    <Stats
      ...
      para="Our services cover the full works: SEO management, audits, and website optimisation. We’re experts in website design and link building. Partner with Mitochon Pixel to tap into our expertise and smash your online goals and growth targets."
