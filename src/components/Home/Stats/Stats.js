...
export default function Stats({stats, heading, para, connectHref, knowMoreHref}) {
  ...
  return (
    <div className="bg-white app__stats py-24 sm:py-32 flex items-center flex-col gap-y-12">
      <Cta heading={heading} para={para} connectHref={connectHref} knowMoreHref={knowMoreHref}/>
